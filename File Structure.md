...
│ ├── Day 01 System Reverse Engineering/
│ ├── Day 02 Implementing Concurrency/
│ ├── Day 03 Git Mastery/
│ ├── Day 04 HTTP and API Forensics/
│ └── Day 05 Automation and MINI Challenges/
│
...
│
├── Week 5 Docker and DevOps Basics/
│ ├── Day 01 Docker Fundamentals and Linux Internals/
│ ├── Day 02 Docker Compose and Multi Container Apps/
│ ├── Day 03 NGINX Reverse Proxy and Load Balancing/
