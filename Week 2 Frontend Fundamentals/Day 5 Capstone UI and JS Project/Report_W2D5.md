...
![Fetch API](./screenshots/Fetch_API.png)
...
![Search Functionality](./screenshots/Search_Func.png)

Price Based Filtering
![Price Based Filtering](./screenshots/Filtering_Func1.png)

Categories Based Filtering
![Categories Based Filtering](./screenshots/Filtering_Func2.png)

Rating Based Filtering
![Rating Based Filtering](./screenshots/Filtering_Func3.png)
...
For Mobile
![Responsive Webpage](./screenshots/Responsive_Mobile.png)

For Tablet
![Responsive Webpage](./screenshots/Responsive_Tablet.png)

## Additional Challenge

**Sticky Header**
Learnt about sticky header where I learnt how it is implemented by CSS property **position: sticky;**
![Sticky Header](./screenshots/Sticky_Header.png)
